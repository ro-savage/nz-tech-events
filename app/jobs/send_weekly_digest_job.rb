class SendWeeklyDigestJob < ApplicationJob
  ...
  def perform
    ...
    EmailSubscription.regions.keys.each do |region|
      ...
      new_events_nz_array = new_events_nz.to_a

      # Send email to each subscriber
      subscriptions.find_each do |subscription|
        WeeklyDigestMailer.digest(subscription, new_events_array, upcoming_events_array, new_events_nz_array).deliver_later
